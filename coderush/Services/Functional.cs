...
//                countries.Add(data); 
                ...
                List<Customer> customers = new List<Customer>()
                {
                    ...
                    new Customer
                        {CustomerName = "HILARION-Abastos", Address = "Carrera 22 con Ave. Carlos Soublette #8-35"},
                    new Customer
                        {CustomerName = "Hungry Coyote Import Store", Address = "City Center Plaza 516 Main St."},
                    ...
                    new Customer
                    {
                        CustomerName = "LILA-Supermercado", Address = "Carrera 52 con Ave. Bolívar #65-98 Llano Largo"
                    },
                ...
                List<Vendor> vendors = new List<Vendor>()
                {
                    ...
                    new Vendor
                    {
                        VendorName = "New England Seafood Cannery",

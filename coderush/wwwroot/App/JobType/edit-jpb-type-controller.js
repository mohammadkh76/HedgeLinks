adminModule.controller('editJobTypeController', ['$scope', '$uibModalInstance', 'dataService', '$window', 'toaster', function ($scope, $uibModalInstance, dataService, $window, toaster) {
    ...
    $scope.confirmEdit = function () {
        ...
        dataService.post('/api/JobType/Edit/', $scope.editData).then(function (res) {
            if (res.data.Status == 'success') {

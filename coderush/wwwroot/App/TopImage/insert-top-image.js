adminModule.controller('insertTopImageController', ['$scope', '$uibModalInstance', 'dataService', '$window', 'toaster', 'Upload', 'convertorService', function ($scope, $uibModalInstance, dataService, $window, toaster, Upload, convertorService) {
    ...
    $scope.confirmInsert = function (res) {
        ...
        Upload.upload({
            url: '/api/TopImage/Insert',
            data: {
                ImageTitle: $scope.Title,
                ImageSubtitle: $scope.Subtitle,
